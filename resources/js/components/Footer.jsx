...
export default function Footer() {
  return (
    <footer className="backdrop-blur bg-green-700/90 text-white shadow-2xl border-t-2 border-green-500/40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#home" className="text-green-100 hover:text-white transition-colors duration-200">
                  Home
                </a>
              </li>
              <li>
                <a href="#destinations" className="text-green-100 hover:text-white transition-colors duration-200">
                  Destinations
                </a>
              </li>
              <li>
                <a href="#trips" className="text-green-100 hover:text-white transition-colors duration-200">
                  Trips
                </a>
              </li>
              <li>
                <a href="#reviews" className="text-green-100 hover:text-white transition-colors duration-200">
                  Reviews
                </a>
              </li>
            </ul>
