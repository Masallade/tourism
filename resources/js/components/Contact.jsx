  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-blue-50">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your eco-travel plans..."
                ></textarea>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-12 h-12 bg-gradient-to-r from-blue-400 to-blue-600 text-white rounded-lg flex items-center justify-center hover:shadow-lg transition">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                  </svg>
                </a>
                <a href="#" className="w-12 h-12 bg-gradient-to-r from-pink-500 to-red-500 text-white rounded-lg flex items-center justify-center hover:shadow-lg transition">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="w-12 h-12 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg flex items-center justify-center hover:shadow-lg transition">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-gray-200 h-96">
        <iframe
          title="Location Map"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.835434509374!2d144.95373531531677!3d-37.81720997975171!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d4c2b349649%3A0xb6899234e561db11!2sEnvato!5e0!3m2!1sen!2sau!4v1234567890123!5m2!1sen!2sau"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen=""
