...
const ServiceTypesList = () => {
    ...
    const handleDelete = async (serviceType) => {
        ...
        try {
            await window.apiClient.delete(`/api/service-types/${serviceType.id}`);
    ...
    const handleFormSuccess = () => {
        setSuccessMessage(editingServiceType ? 'Service type updated successfully' : 'Service type created successfully');
        setShowForm(false);
        setEditingServiceType(null);
        fetchServiceTypes();
    };
                                ...
                                <tr key={serviceType.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                            {serviceType.service_providers_count || 0} providers
                                        </span>
                                    </td>
